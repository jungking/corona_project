...
const airdata = (sidoName, callback) => {       // index.js에서 보내준 시/도 이름을 여기서 받았다.
    ...
    queryParams += '&' + encodeURIComponent('startCreateDt') + '=' + encodeURIComponent('20200410');    //데이터 생성일 시작범위
    queryParams += '&' + encodeURIComponent('endCreateDt') + '=' + encodeURIComponent('20200410');  //데이터 생성일 종료범위
